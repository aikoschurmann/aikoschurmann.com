                ...
                <div class="unified-bar">
                  {#each buildTimeline(row) as seg}
                    <div class="ub-seg {seg.type}" style="--base-flex: {seg.flex}">
                      ...
                      <div class="ub-lbl">
                        {#if seg.type === 'warmup'}
                          <svg class="seg-icon" viewBox="0 0 24 24"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
                        {:else if seg.type === 'work'}
                          <svg class="seg-icon" viewBox="0 0 24 24"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        {:else if seg.type === 'rest'}
                          <svg class="seg-icon" viewBox="0 0 24 24"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>
                        {:else if seg.type === 'cooldown'}
                          <svg class="seg-icon" viewBox="0 0 24 24"><polyline points="23 18 13.5 8.5 8.5 13.5 1 6"></polyline><polyline points="17 18 23 18 23 12"></polyline></svg>
                        {/if}
                      </div>
